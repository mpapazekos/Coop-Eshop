...
using Project_WebCoop.Models.AccountViewModels;
...
namespace Project_WebCoop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {          
                    ...
                    else if (roles.Contains("MerchantRole"))
                    {
                        returnUrl = "/Merchant/Index";
                    }
                    else if (roles.Contains("ClientRole"))
                    {
        ...
        //[HttpGet]
        //[AllowAnonymous]
        //public IActionResult RegisterMerchant(string returnUrl = null)
        //{
        //    ViewData["ReturnUrl"] = returnUrl;
        //    return View();
        //}
